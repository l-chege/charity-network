                            ...
                            //verify email code starts
                             fAuth.getCurrentUser().sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    verificationLinkSent = task.isSuccessful();
                                }
                            });
                            //verify email ends
                            ...
                            user.put("category", userCategory);
                             documentReference.set(user).addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onSuccess(Void aVoid) {
                                   ...
                                   {
                                        Toast.makeText(Registration.this, "Registered successfully!A verification link has been sent to your email",Toast.LENGTH_LONG).show();
                                    }
                                    else
