...
public class createPost extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        category = findViewById(R.id.choseCategory);
        orgName = findViewById(R.id.organizationName);
        title = findViewById(R.id.addTitle);
        share = findViewById(R.id.button_apply);
        details = findViewById(R.id.addDescription);
        location = findViewById(R.id.addLocation);
        addDate = findViewById(R.id.addLastDate);
